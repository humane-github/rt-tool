 ...
 */
@Component
public class InPortConverter implements Converter<InPortParam> {
    ...
    public boolean supports(Class<?> type, String optionContext) {
        return InPortParam.class.isAssignableFrom(type);    }
     ...
     */
    @Override
    public InPortParam convertFromText(String value, Class<?> targetType, String optionContext) {

        InPortParam portParam = new InPortParam();
